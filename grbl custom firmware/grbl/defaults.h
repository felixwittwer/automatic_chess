...
#ifdef GDP_CHESS_360MM_360MM
  // GDP Chess configuration keep in mind, since we are using CoreXY kinematics only values for X and Y are important.
  #define DEFAULT_X_STEPS_PER_MM 5.0
  #define DEFAULT_Y_STEPS_PER_MM 5.0
  #define DEFAULT_Z_STEPS_PER_MM 5.0
  #define DEFAULT_X_MAX_RATE 10000.0 // mm/min
  #define DEFAULT_Y_MAX_RATE 10000.0 // mm/min
  #define DEFAULT_Z_MAX_RATE 10000.0 // mm/min
  #define DEFAULT_X_ACCELERATION 5000 // mm/min^2
  #define DEFAULT_Y_ACCELERATION 5000 // mm/min^2
  #define DEFAULT_Z_ACCELERATION 5000 // mm/min^2
  #define DEFAULT_X_MAX_TRAVEL 360.0 // mm NOTE: Must be a positive value.
  #define DEFAULT_Y_MAX_TRAVEL 360.0 // mm NOTE: Must be a positive value.
  #define DEFAULT_Z_MAX_TRAVEL 360.0 // mm NOTE: Must be a positive value.
  #define DEFAULT_SPINDLE_RPM_MAX 1000.0 // rpm
  #define DEFAULT_SPINDLE_RPM_MIN 0.0 // rpm
  #define DEFAULT_STEP_PULSE_MICROSECONDS 10
  #define DEFAULT_STEPPING_INVERT_MASK 0
